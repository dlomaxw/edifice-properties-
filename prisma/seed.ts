...
async function main() {
  ...
  const propertyImages = [
    ...
    // Signature Residency
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/B.png', category: 'exterior', label: 'Facade Street Perspective', description: 'Modern architectural exterior showcasing premium finishes and landscaped approach.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/C.png', category: 'exterior', label: 'Facade Corner View', description: 'Detailed corner view displaying the modern balconies and architectural elevation.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/D.png', category: 'exterior', label: 'Facade Side View', description: 'Zoomed perspective highlighting double-aspect balconies and premium color blocks.' },

    // Signature Residency Interior Showcase
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/interior/1bhk.png', category: 'interior', label: 'Signature 1BHK Living & Lounge Area', description: 'Bright and spacious 1BHK living salon featuring custom wall paneling, ceiling lighting details, and large view windows.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/interior/1bhk-a.png', category: 'interior', label: 'Signature 1BHK Master Suite', description: 'Comfortable master bedroom with plush headboard detailing and ample natural sunlight.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/interior/1bhk-b.png', category: 'interior', label: 'Signature 1BHK Fitted Kitchen', description: 'Sleek modular kitchen cabinetry equipped with quartz tops and built-in cooking range.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/interior/2bhk.png', category: 'interior', label: 'Signature 2BHK Salon Lounge', description: 'Expansive family living and dining area with dual aspect windows and balcony access.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/interior/2bhk-a.png', category: 'interior', label: 'Signature 2BHK Bedroom Suite', description: 'Elegant bedroom space with built-in wardrobes and contemporary interior finishes.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/interior/2bhk-b.png', category: 'interior', label: 'Signature 2BHK Luxury Bathroom', description: 'Stylishly finished washroom with wall-mounted vanity, glass shower enclosure, and premium tiles.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/interior/3bhk.png', category: 'interior', label: 'Signature 3BHK Executive Living Lounge', description: 'Grand executive salon space offering seamless flow into dining and terrace viewing areas.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/interior/3bhk-a.png', category: 'interior', label: 'Signature 3BHK Penthouse Master Bedroom', description: 'Luxury master bedroom suite highlighting floor-to-ceiling glass and private balcony entrance.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/interior/3bhk-b.png', category: 'interior', label: 'Signature 3BHK Kitchen & Dining Area', description: 'State-of-the-art kitchen with integrated island breakfast bar and utility area.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/E.png', category: 'interior', label: 'Executive Lounge View', description: 'Bright living space showing custom architectural ceiling details.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/F.png', category: 'interior', label: 'Modular Fitted Kitchen', description: 'High-end fitted kitchen layout featuring premium cabinets.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/FOYER-01.png', category: 'interior', label: 'Grand Entrance Foyer', description: 'Elegant entrance foyer welcoming residents with luxury detailing.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/G.png', category: 'interior', label: 'Master Bedroom View', description: 'Bespoke master suite bedroom design detailing plush headboard panels.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/H.png', category: 'interior', label: 'Modern Dining Salon', description: 'Sophisticated dining salon space seamlessly connected with main lounge.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/I.png', category: 'interior', label: 'Contemporary Washroom', description: 'Stylishly finished bathroom layout with premium fixtures.' },

    // Signature Residency Floor Plans & Sizing Sheets (Rendered from official PDF blueprints!)
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/dimensions%26sizing%20sheets/signature_residency_cut_iso_1bhk_1.png', category: 'floorplan', label: '1BHK Dimensions & Sizing Sheets', description: 'Technical cut-iso architectural drawing demonstrating 1BHK room boundaries, structural walls, and sizing specs.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/dimensions%26sizing%20sheets/signature_residency_cut_iso_2bhk_1.png', category: 'floorplan', label: '2BHK Dimensions & Sizing Sheets', description: 'Comprehensive 2-bedroom dimensions outlining balcony spaces, living area, and kitchen layout.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/dimensions%26sizing%20sheets/signature_residency_cut_iso_3bhk_1.png', category: 'floorplan', label: '3BHK Executive Penthouses Layout', description: 'Upper floor planning detailing 3-bedroom executive layout and penthouse sizing sheets.' }
  ];
