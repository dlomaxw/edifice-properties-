...
async function main() {
  ...
  const settings = [
    ...
    { key: 'cofounder2_image', value: '/assets/edifice/home/home-cofounder-mau.jpg', description: 'Co-founder 2 photo path' },
    ...
    { key: 'home_video_thumbnail', value: '/assets/edifice/properties/horizon-residency-card.jpg', description: 'Cinematic video cover thumbnail' },
    { key: 'youtube_hero_url', value: 'https://youtu.be/Eact7djAeQc', description: 'Background video link for Homepage' },
  ...
  const horizon = await prisma.property.create({
    data: {
      ...
      description: 'Horizon Residency is a luxury apartment development by Edifice Properties located on Luthuli Avenue, Bugolobi. It offers modern 1BHK, 2BHK, and 3BHK apartments with high-end features, functional layouts, and resort-style amenities.',
      fullDescription: 'Horizon Residency represents the pinnacle of urban sophistication for anyone looking to buy an apartment in Bugolobi, Kampala. Located on prestigious Luthuli Avenue (opposite Dolphin Suites), it offers luxury 1, 2, and 3 bedroom apartments for sale starting at $92,000. Features include floor-to-ceiling glass, dual-aspect viewing balconies, and high rental yield potential.',
      startingPrice: 92000,
      currency: 'USD',
      status: 'Available',
      type: 'Apartment',
      ...
      mainImage: '/assets/edifice/properties/horizon-residency-card.jpg',
      ...
      youtubeUrl: 'https://youtu.be/5SdItw9WkAE',
      featured: true,
      seoTitle: 'Apartments for Sale in Bugolobi Kampala | Horizon Residency',
      seoDescription: 'Discover luxury apartments for sale in Bugolobi, Kampala at Horizon Residency on Luthuli Avenue. 1, 2 & 3 BHK suites starting at $92,000 with high rental yields.',
      orderIndex: 2,
    },
  });
  ...
  await prisma.unit.createMany({
    data: [
      ...
      },
      {
        ...
        floorPlanImage: '/assets/edifice/horizon-residency/horizon-residency-floorplan-2bhk.png',
      },
      {
        propertyId: horizon.id,
        name: 'Horizon 3BHK',
  ...
  const embassy = await prisma.property.create({
    data: {
      ...
      description: 'High-rise apartments for sale on Kampala Road in Kampala CBD. Embassy Towers offers prime investment apartments in Kampala city centre with one-bedroom, two-bedroom, and three-bedroom buy-to-let suites.',
      fullDescription: 'Looking for luxury apartments for sale in Kampala CBD? Embassy Towers is an iconic high-rise residential tower located directly on Kampala Road in Kampala city centre. Offering one-bedroom apartment units for Kampala CBD professionals and spacious three-bedroom apartment suites for city centre living, it represents an outstanding buy-to-let investment apartment opportunity on Kampala Road starting at just $68,000. Features include double-glazed acoustic windows, high-speed passenger elevators, and 24/7 security.',
      startingPrice: 68000,
      currency: 'USD',
      status: 'Available',
      type: 'Apartment',
      ...
      youtubeUrl: 'https://youtu.be/cintZUdWXYY',
      featured: true,
      seoTitle: 'Apartments for Sale on Kampala Road | Embassy Towers',
      seoDescription: 'High-rise apartments for sale on Kampala Road in Kampala CBD. Embassy Towers offers prime 1, 2, and 3 bedroom investment apartments in Kampala city centre starting at $68,000.',
      orderIndex: 3,
    },
  });
    ...
    data: [
      {
        ...
        bathrooms: 1,
        status: 'Available',
        description: 'One-bedroom apartment Kampala CBD unit: Open living space designed to maximize natural light, compact modular kitchen, and private balcony.',
      ...
      },
      {
        ...
        bathrooms: 2,
        status: 'Available',
        description: 'Two-bedroom buy-to-let investment apartment on Kampala Road: Bright, airy salon, master bedroom with ensuite bath and balcony, and modular kitchen.',
        floorPlanImage: '/assets/edifice/embassy-towers/embassy-towers-floorplan-01.png',
      },
      {
        propertyId: embassy.id,
        ...
        bathrooms: 3,
        status: 'Available',
        description: 'Three-bedroom apartment Kampala city centre penthouse: Grand central salon, master suite with walk-in closet, and utility room.',
  ...
  const elite = await prisma.property.create({
    data: {
      ...
      description: 'Elite Palazzo Naguru is a completed luxury apartment development by Edifice Properties, located at Kampala’s highest hilltop elevation in Naguru.',
      fullDescription: 'Standing at the prestigious crossroads of Naguru/Ntinda II road, Elite Palazzo Naguru represents a landmark completed luxury residence by Edifice Properties. Handed over to proud homeowners, it stands as proof of Edifice’s architectural quality and premium finish standards.',
      ...
      youtubeUrl: 'https://youtu.be/n3lhXEN9_Hs',
      featured: true,
      seoTitle: 'Elite Palazzo Naguru | Completed Luxury Apartment Development',
      seoDescription: 'Elite Palazzo Naguru by Edifice Properties. Completed luxury apartment development at Kampala’s highest hilltop location in Naguru.',
      orderIndex: 4,
    },
  });
    ...
    data: [
      {
        ...
        bathrooms: 2,
        status: 'Sold out',
        description: 'Spacious living and dining area, modern open-plan kitchen, elegant interiors with high-quality finishes. (Sold out)',
      ...
      },
      {
        ...
        bathrooms: 3,
        status: 'Sold out',
        description: 'Designed for comfort and long-term value. Includes a large living and dining area, fully fitted modern kitchen, three bedrooms with master ensuite. (Sold out)',
  ...
  const atlantic = await prisma.property.create({
    data: {
      ...
      description: 'Atlantic Apartments offers modern apartments for sale in Bukoto, Kampala. Located close to top international schools, shopping centers, and medical hubs.',
      fullDescription: 'Looking to buy an apartment in Bukoto, Kampala? Atlantic Apartments (Atlantic Heights) delivers outstanding 2BHK and 3BHK luxury residences starting at $97,000. Built with high-end fixtures, secure parking, and top rental yields.',
      startingPrice: 97000,
      currency: 'USD',
      ...
      youtubeUrl: 'https://youtu.be/kqrNYOfY-N8',
      featured: false,
      seoTitle: 'Apartments for Sale in Bukoto Kampala | Atlantic Apartments',
      seoDescription: 'Buy luxury 2BHK & 3BHK apartments for sale in Bukoto, Kampala at Atlantic Apartments (Atlantic Heights). Premium rental yield units starting at $97,000.',
      orderIndex: 5,
    },
  });
  ...
  const urban = await prisma.property.create({
    data: {
      ...
      description: 'Urban View is a completed residential community in Kulambiro, Kampala. Built by Edifice Properties for professionals, families, and investors.',
      ...
      youtubeUrl: 'https://youtu.be/_YhgBQ4Ijns',
      featured: false,
      seoTitle: 'Urban View Apartments Kulambiro | Completed Residence',
      seoDescription: 'Urban View Apartments in Kulambiro, Kampala. Fully sold out high-rise residential community built and handed over by Edifice Properties.',
      orderIndex: 6,
    },
  });

  // Signature Residency
  const signature = await prisma.property.create({
    data: {
      id: 'signature-residency',
      name: 'Signature Residency',
      slug: 'signature-residency',
      location: 'Kulambiro, Kampala',
      description: 'Experience modern living at Signature Residency, Kulambiro – luxury 1, 2, and 3 bedroom apartments for sale in Kulambiro, Kampala.',
      fullDescription: 'Looking for 1, 2 or 3 bedroom apartments for sale in Kulambiro, Kampala? Signature Residency by Edifice Properties offers modern 1BHK, 2BHK, & 3BHK suites starting at 180,000,000 UGX. Features include children\'s play area, steam & sauna, fully equipped gym, generator backup, society office, and terrace sitting & gardens across 3 blocks of 10 floors.',
      ...
      bedrooms: '1BHK, 2BHK, 3BHK',
      bathrooms: '1-3',
      sizeRange: '63–134 sqm',
      mainImage: '/assets/edifice/signature-residency/B.png',
      mapUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.713601579294!2d32.617300714754026!3d0.37050309972985166!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x177dbba2c366ff05%3A0xe54d588523dfad2c!2sKulambiro%2C%20Kampala!5e0!3m2!1sen!2sug!4v1700000000004!5m2!1sen!2sug',
      youtubeUrl: 'https://youtu.be/Eact7djAeQc',
      featured: true,
      seoTitle: 'Apartments for Sale in Kulambiro Kampala | Signature Residency',
      seoDescription: 'Buy 1, 2 & 3 bedroom apartments for sale in Kulambiro, Kampala at Signature Residency. Launching Phase 1 at 180M UGX with gym, sauna & generator backup.',
      orderIndex: 1,
    },
  });
  ...
  await prisma.unit.createMany({
    data: [
      ...
      },
      {
        ...
        bathrooms: 1,
        status: 'Available',
        description: 'Modern 1BHK layout with spacious living & dining area, modular kitchen, elegant bedroom, premium bathroom, and balcony.',
        floorPlanImage: '/assets/edifice/signature%20residency/B.png',
      },
      {
        propertyId: signature.id,
        name: 'Signature 2BHK',
        ...
        bathrooms: 2,
        status: 'Available',
        description: 'Premium 2BHK layout featuring large living-dining salon, fully fitted modular kitchen, master suite with en-suite bath, second bedroom, common bathroom, and private balcony.',
        floorPlanImage: '/assets/edifice/signature%20residency/C.png',
      },
      {
        propertyId: signature.id,
        name: 'Signature 3BHK',
        ...
        bathrooms: 3,
        status: 'Available',
        description: 'Executive 3BHK layout offering grand living and dining space, modern fitted kitchen with store, master suite with private balcony, two additional bedrooms (one en-suite, one with shared bath), and multiple balconies.',
        floorPlanImage: '/assets/edifice/signature%20residency/D.png',
      },
    ],
  });
  ...
  const propertyImages = [
    // Horizon Residency
    { propertyId: 'horizon-residency', url: '/assets/edifice/properties/horizon-residency-card.jpg', category: 'exterior', label: 'Architectural Exterior Facade', description: 'High-elevation street-side perspective of the Horizon Residency twin tower blocks.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-facade-street.jpg', category: 'exterior', label: 'Facade Street View', description: 'Detailed street perspective displaying the modern verticality and premium design of Horizon Residency.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-facade-corner.jpg', category: 'exterior', label: 'Facade Corner View', description: 'Direct corner view displaying the modern balconies and landscaped street approach.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-facade-side.jpg', category: 'exterior', label: 'Balcony Facade Perspective', description: 'Zoomed view of the modern vertical structure showing balconies and clean exterior finishes.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-facade-vertical.jpg', category: 'exterior', label: 'Vertical Facade Detail', description: 'Close-up of the facade detailing double-aspect balconies and premium color blocks.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-aerial-top.jpg', category: 'exterior', label: 'Rooftop Aerial Perspective', description: 'Stunning top-down rendering highlighting the rooftop garden terraces and building footprint.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-birds-eye.jpg', category: 'exterior', label: 'Birds-Eye Landmark View', description: 'High-angle perspective displaying the architectural layouts, top-deck, and road integrations.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-ground-entrance-01.jpg', category: 'exterior', label: 'Ground Entrance Approach', description: 'Entrance approach rendering highlighting columns, paved parking area, and landscaping.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-lobby-entrance.jpg', category: 'exterior', label: 'Glass Lobby & Drop-off Zone', description: 'Close-up of the main ground entrance displaying glass panels, columns, and drop-off zones.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-rooftop-lounge-01.jpg', category: 'interior', label: 'Rooftop Lounge Seating', description: 'Close-up rendering of the rooftop terrace lounge featuring red sofas and wooden pergolas.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-rooftop-lounge-02.jpg', category: 'interior', label: 'Rooftop Terrace Overview', description: 'Overview of the rooftop lounge recreation deck with outdoor furniture and skyline views.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-rooftop-pergola.jpg', category: 'interior', label: 'Pergola Dining & Seating Area', description: 'Relaxed dining and lounge area on the rooftop deck under open wooden pergolas.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-pool.png', category: 'interior', label: 'Recreation Swimming Pool', description: 'Shimmering swimming pool on the deck with relaxation loungers and play areas.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-walkthrough-01.png', category: 'interior', label: 'Bespoke Bathroom Design', description: 'Horizon Residency luxury bathroom mockup rendering with premium fittings.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-walkthrough-02.png', category: 'interior', label: 'Master Bedroom Suite', description: 'Horizon Residency modern open layout master suite room design.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-walkthrough-03.png', category: 'interior', label: 'Dining & Living Salon', description: 'Horizon Residency spacious dining and living salon overview.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-walkthrough-04.png', category: 'interior', label: 'Guest Suite Design', description: 'Horizon Residency guest suite room design visualization.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-walkthrough-05.png', category: 'interior', label: 'Premium Fitted Kitchen', description: 'Horizon Residency premium kitchen utility cabinets layout.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-walkthrough-06.png', category: 'interior', label: 'Cozy Second Lounge', description: 'Horizon Residency cozy second lounge space rendering.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-walkthrough-07.png', category: 'interior', label: 'Bespoke Walk-in Closet', description: 'Horizon Residency custom bedroom walk-in closet renders.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-walkthrough-08.png', category: 'interior', label: 'Hallway & Foyer Paneling', description: 'Horizon Residency entrance foyer and hallway paneling layout.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-aerial-top.jpg', category: 'floorplan', label: 'Development Block Diagram Layout', description: 'Detailed site map and blocks routing overview demonstrating secure neighborhood boundary lines.' },
    ...
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-floorplan-2bhk.png', category: 'floorplan', label: 'Apartment Type 3 Layout Specifications', description: 'Engineering plans highlighting two bedrooms and spacious en-suite family dimensions.' },
    ...
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-hero.webp', category: 'exterior', label: 'Architectural Facade & Entrance', description: 'Stunning contemporary exterior facade featuring warm illumination and manicured grounds.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-facade-street.jpg', category: 'exterior', label: 'Luthuli Avenue Street View', description: 'Sleek architectural presence nestled in the prime embassy heart of Bugolobi.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-ground-entrance-01.jpg', category: 'exterior', label: 'Ground Floor Reception Arrival', description: 'Drop-off concierge porte-cochere with 24/7 manned security checkpoint.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-lounge-01.jpg', category: 'exterior', label: 'Skyline Terrace Lounge', description: 'Panoramas across Lake Victoria and Bugolobi green canopy.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-gallery-01.webp', category: 'interior', label: 'Luxury Living Salon', description: 'Expansive open-plan living room with floor-to-ceiling windows and Italian floor porcelain.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-gallery-02.webp', category: 'interior', label: 'Fitted Gourmet Kitchen', description: 'Custom fitted cabinetry with quartz countertops and integrated European appliances.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-gallery-03.webp', category: 'interior', label: 'Master Bedroom Suite', description: 'Spacious master suite featuring private viewing balcony and custom built-in wardrobes.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-gallery-04.webp', category: 'interior', label: 'Spa-Inspired Bathroom', description: 'Designer vanity units, frameless glass shower enclosure, and rainfall showerhead.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-floorplan-1bhk.png', category: 'floorplan', label: '1BHK Luxury Layout (60 sqm)', description: 'Optimized single-bedroom layout with seamless indoor-outdoor terrace integration.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-floorplan-2bhk.png', category: 'floorplan', label: '2BHK Executive Layout (95 sqm)', description: 'Dual ensuite bedrooms, guest washroom, and expansive corner balcony.' },
    { propertyId: 'horizon-residency', url: '/assets/edifice/horizon-residency/horizon-residency-floorplan-3bhk.png', category: 'floorplan', label: '3BHK Family Penthouse Layout (140 sqm)', description: 'Sprawling family penthouse layout with maid quarters, utility room, and wraparound terrace.' },
    ...
    { propertyId: 'embassy-towers', url: '/assets/edifice/embassy-towers/embassy-towers-hero.webp', category: 'exterior', label: 'Embassy Towers Exterior Elevation', description: 'State-of-the-art high-rise architectural tower commanding views over Kampala CBD.' },
    { propertyId: 'embassy-towers', url: '/assets/edifice/embassy-towers/embassy-towers-construction-01.jpeg', category: 'exterior', label: 'Substructure Excavation Phase', description: 'Heavy earthmoving machinery excavating deep basement parking levels.' },
    { propertyId: 'embassy-towers', url: '/assets/edifice/embassy-towers/embassy-towers-construction-02.jpeg', category: 'exterior', label: 'Reinforced Concrete Foundation Piles', description: 'Laying heavy steel rebar matrices and pouring high-grade concrete footings.' },
    { propertyId: 'embassy-towers', url: '/assets/edifice/embassy-towers/embassy-towers-construction-03.jpeg', category: 'exterior', label: 'Podium Deck Formwork', description: 'Active construction crew assembling column shoring and floor deck formwork.' },
    { propertyId: 'embassy-towers', url: '/assets/edifice/embassy-towers/embassy-towers-construction-04.jpeg', category: 'exterior', label: 'Tower Crane Operations', description: 'Tower crane hoisting structural beam steelwork for the upper residential floors.' },
    { propertyId: 'embassy-towers', url: '/assets/edifice/embassy-towers/embassy-towers-interior-01.png', category: 'interior', label: 'Executive Living Salon', description: 'Open-concept living space highlighting floor-to-ceiling glass and panoramic city views.' },
    { propertyId: 'embassy-towers', url: '/assets/edifice/embassy-towers/embassy-towers-interior-02.png', category: 'interior', label: 'Bespoke Fitted Kitchen', description: 'Modern kitchen island with quartz countertops and soft-close cabinetry.' },
    { propertyId: 'embassy-towers', url: '/assets/edifice/embassy-towers/embassy-towers-interior-03.png', category: 'interior', label: 'Master Penthouse Suite', description: 'Spacious bedroom suite featuring timber accent paneling and direct balcony access.' },
    { propertyId: 'embassy-towers', url: '/assets/edifice/embassy-towers/embassy-towers-floorplan-01.png', category: 'floorplan', label: 'Executive 2BHK Tower Layout', description: 'Optimized floor plan showing structural boundaries, balcony access, and room dimensions.' },
    { propertyId: 'embassy-towers', url: '/assets/edifice/embassy-towers/embassy-towers-floorplan-02.png', category: 'floorplan', label: 'Grand 3BHK Penthouse Layout', description: 'Spacious 3-bedroom layout detailing ensuite washrooms and private balcony placement.' },
    { propertyId: 'embassy-towers', url: '/assets/edifice/embassy-towers/embassy-towers-flyer.png', category: 'floorplan', label: 'Embassy Towers Specification Flyer', description: 'High-resolution project brochure highlighting amenity details and payment structure.' },
    ...
    { propertyId: 'elite-palazzo-naguru', url: '/assets/edifice/elite-palazzo/elite-palazzo-interior-01.png', category: 'interior', label: 'Living Room Salon Showcase', description: 'Spacious salon lounge featuring custom wall paneling, ceiling lighting details, and scenery view windows.' },
    ...
    { propertyId: 'elite-palazzo-naguru', url: '/assets/edifice/elite-palazzo/elite-palazzo-interior-04.png', category: 'interior', label: 'State-of-the-Art Luxury Kitchen', description: 'High-end fitted kitchen layout featuring premium cabinets, built-in double oven, and cooking range.' },
    ...
    { propertyId: 'atlantic-apartments', url: '/assets/edifice/atlantic-apartments/atlantic-apartments-gallery-01.png', category: 'exterior', label: 'Atlantic Heights Aerial Drone', description: 'Top-down view showing the green landscaping and site perimeter.' },
    { propertyId: 'atlantic-apartments', url: '/assets/edifice/atlantic-apartments/atlantic-apartments-gallery-02.png', category: 'exterior', label: 'Atlantic Heights Perspective', description: 'Elevation view of the premium apartment towers from street level.' },
    { propertyId: 'atlantic-apartments', url: '/assets/edifice/atlantic-apartments/atlantic-apartments-gallery-03.png', category: 'interior', label: 'Luxury Living Salon', description: 'Sophisticated open-plan living lounge with broad windows and dining area.' },
    { propertyId: 'atlantic-apartments', url: '/assets/edifice/atlantic-apartments/atlantic-apartments-gallery-04.png', category: 'interior', label: 'Master Suite Walk-in', description: 'Master bedroom visualization highlighting layout space and premium wardrobes.' },
    { propertyId: 'atlantic-apartments', url: '/assets/edifice/atlantic-apartments/atlantic-apartments-gallery-05.png', category: 'interior', label: 'Modern Fitted Kitchen', description: 'Sleek kitchen counters featuring integrated cooktops and white quartz tops.' },
    { propertyId: 'atlantic-apartments', url: '/assets/edifice/atlantic-apartments/atlantic-apartments-gallery-06.png', category: 'interior', label: 'Bespoke Dining Corner', description: 'Warm wood detailing and ambient light fixtures over the dining area.' },
    ...
    { propertyId: 'atlantic-apartments', url: '/assets/edifice/atlantic-apartments/atlantic-apartments-site-diagram.jpg', category: 'floorplan', label: 'Site Layout Blueprint', description: 'Comprehensive site plan showing parking routing, access control points, and gardens.' },
    { propertyId: 'atlantic-apartments', url: '/assets/edifice/atlantic-apartments/atlantic-apartments-2bhk-dimensions.jpg', category: 'floorplan', label: '2BHK Layout Dimensions', description: 'Floor plan detailing exact dimension sheets for bedrooms, baths, and living spaces.' },
    { propertyId: 'atlantic-apartments', url: '/assets/edifice/atlantic-apartments/atlantic-apartments-3bhk-dimensions.jpg', category: 'floorplan', label: '3BHK Layout Dimensions', description: 'Floor plan detailing exact dimension sheets for the sprawling 3-bedroom penthouses.' },
    ...
    // Signature Residency
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/B.png', category: 'exterior', label: 'Facade Street Perspective', description: 'Modern architectural exterior showcasing premium finishes and landscaped approach.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/C.png', category: 'exterior', label: 'Facade Corner View', description: 'Detailed corner view displaying the modern balconies and architectural elevation.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/D.png', category: 'exterior', label: 'Facade Side View', description: 'Zoomed perspective highlighting double-aspect balconies and premium color blocks.' },

    // Signature Residency Interior Showcase
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/interior/1bhk.png', category: 'interior', label: 'Signature 1BHK Living & Lounge Area', description: 'Bright and spacious 1BHK living salon featuring custom wall paneling, ceiling lighting details, and large view windows.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/interior/1bhk-a.png', category: 'interior', label: 'Signature 1BHK Master Suite', description: 'Comfortable master bedroom with plush headboard detailing and ample natural sunlight.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/interior/1bhk-b.png', category: 'interior', label: 'Signature 1BHK Fitted Kitchen', description: 'Sleek modular kitchen cabinetry equipped with quartz tops and built-in cooking range.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/interior/2bhk.png', category: 'interior', label: 'Signature 2BHK Salon Lounge', description: 'Expansive family living and dining area with dual aspect windows and balcony access.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/interior/2bhk-a.png', category: 'interior', label: 'Signature 2BHK Bedroom Suite', description: 'Elegant bedroom space with built-in wardrobes and contemporary interior finishes.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/interior/2bhk-b.png', category: 'interior', label: 'Signature 2BHK Luxury Bathroom', description: 'Stylishly finished washroom with wall-mounted vanity, glass shower enclosure, and premium tiles.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/interior/3bhk.png', category: 'interior', label: 'Signature 3BHK Executive Living Lounge', description: 'Grand executive salon space offering seamless flow into dining and terrace viewing areas.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/interior/3bhk-a.png', category: 'interior', label: 'Signature 3BHK Penthouse Master Bedroom', description: 'Luxury master bedroom suite highlighting floor-to-ceiling glass and private balcony entrance.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/interior/3bhk-b.png', category: 'interior', label: 'Signature 3BHK Kitchen & Dining Area', description: 'State-of-the-art kitchen with integrated island breakfast bar and utility area.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/E.png', category: 'interior', label: 'Executive Lounge View', description: 'Bright living space showing custom architectural ceiling details.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/F.png', category: 'interior', label: 'Modular Fitted Kitchen', description: 'High-end fitted kitchen layout featuring premium cabinets.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/FOYER-01.png', category: 'interior', label: 'Grand Entrance Foyer', description: 'Elegant entrance foyer welcoming residents with luxury detailing.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/G.png', category: 'interior', label: 'Master Bedroom View', description: 'Bespoke master suite bedroom design detailing plush headboard panels.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/H.png', category: 'interior', label: 'Modern Dining Salon', description: 'Sophisticated dining salon space seamlessly connected with main lounge.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/I.png', category: 'interior', label: 'Contemporary Washroom', description: 'Stylishly finished bathroom layout with premium fixtures.' },

    // Signature Residency Floor Plans & Sizing Sheets
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/dimensions-sizing-sheets/signature-residency-cut-iso-1bhk.png', category: 'floorplan', label: '1BHK Dimensions & Sizing Sheets', description: 'Technical cut-iso architectural drawing demonstrating 1BHK room boundaries, structural walls, and sizing specs.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/dimensions-sizing-sheets/signature-residency-cut-iso-2bhk.png', category: 'floorplan', label: '2BHK Dimensions & Sizing Sheets', description: 'Comprehensive 2-bedroom dimensions outlining balcony spaces, living area, and kitchen layout.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature-residency/dimensions-sizing-sheets/signature-residency-cut-iso-3bhk.png', category: 'floorplan', label: '3BHK Executive Penthouses Layout', description: 'Upper floor planning detailing 3-bedroom executive layout and penthouse sizing sheets.' }
  ];
