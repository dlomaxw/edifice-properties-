...
import { Shield, Sparkles, Sprout, HeartHandshake, Eye, Phone, Mail } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          <div className="flex items-center gap-3">
            ...
            <p className="text-xs font-bold tracking-widest uppercase text-white/90">
              Exclusive Portfolio Offer
            </p>
          </div>
          <p className="text-sm text-gold-500 font-semibold tracking-wide">
            Discount of up to 3% on specific 1BHK, 2BHK & 3BHK premium suites. Limited inventory remaining.
          </p>
        </div>
      </section>
          ...
          <ScrollReveal direction="up" delay={0.1}>
            <div className="max-w-3xl mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-[#0a192f] tracking-tight mt-2 leading-[1.15]">
                Beyond shaping skylines, Edifice is shaping futures
              </h2>
              <p className="text-zinc-500 text-sm md:text-base mt-4 leading-relaxed">
                Dive into our world where architectural prowess meets natural design, curating urban oases that redefine modern living in Kampala.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal direction="left" delay={0.1}>
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-white tracking-tight mt-2 leading-[1.15]">
                Redefining urban spaces for future living
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <ScrollReveal direction="up" delay={0.1}>
              <div className="bg-white/5 border border-white/5 p-6 rounded-2xl flex flex-col gap-4 hover:border-gold-500/40 hover:bg-white/10 transition-all duration-300">
                ...
                <h3 className="text-lg font-heading font-bold">Innovate Luxury</h3>
                <p className="text-xs text-white/50 leading-relaxed">
                  Develop high-quality, luxurious residential and commercial properties that leverage the latest in technology and architectural thinking, remaining financially accessible.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.2}>
              <div className="bg-white/5 border border-white/5 p-6 rounded-2xl flex flex-col gap-4 hover:border-gold-500/40 hover:bg-white/10 transition-all duration-300">
                ...
                <h3 className="text-lg font-heading font-bold">Sustainability</h3>
                <p className="text-xs text-white/50 leading-relaxed">
                  Commit to environmentally responsible building practices that minimize ecological impact, incorporating green tech and renewable materials where possible.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.3}>
              <div className="bg-white/5 border border-white/5 p-6 rounded-2xl flex flex-col gap-4 hover:border-gold-500/40 hover:bg-white/10 transition-all duration-300">
                ...
                <h3 className="text-lg font-heading font-bold">Enhance Lifestyles</h3>
                <p className="text-xs text-white/50 leading-relaxed">
                  Focus on properties that offer enhanced lifestyles through smart-home ready systems, resort-style shared amenities, and wellness-focused communal designs.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.4}>
              <div className="bg-white/5 border border-white/5 p-6 rounded-2xl flex flex-col gap-4 hover:border-gold-500/40 hover:bg-white/10 transition-all duration-300">
                ...
                <h3 className="text-lg font-heading font-bold">Customer Focus</h3>
                <p className="text-xs text-white/50 leading-relaxed">
                  Maintain a steadfast focus on customer satisfaction, providing clear title guarantees, transparent purchase steps, and reliable post-handover support.
                </p>
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <ScrollReveal direction="right" delay={0.2} className="flex">
              <div className="group flex flex-col md:flex-row gap-6 lg:gap-8 items-center md:items-start bg-white p-6 md:p-8 rounded-3xl border border-[#dfc28c]/30 hover:border-[#dfc28c] shadow-lg hover:shadow-xl transition-all duration-300 w-full">
                <div className="relative w-48 h-56 rounded-2xl overflow-hidden shrink-0 bg-[#0a192f] shadow-md border-2 border-[#dfc28c]/30">
                  <img
                    src="/assets/images/Mr.-abbas-Message-02-1.jpg"
                    alt="Abbas Rasheed"
                ...
                <div className="flex flex-col justify-center text-center md:text-left">
                  ...
                  <h3 className="font-heading text-xl md:text-2xl font-bold text-[#0a192f] mt-1">Abbas Rasheed</h3>
                  <span className="text-xs text-zinc-400 font-semibold mt-0.5">C. E. O, Edifice Properties Limited</span>
                  <p className="text-zinc-500 text-xs md:text-sm leading-relaxed mt-4">
                    &ldquo;Our focus is to redefine the standard of living by integrating cutting-edge technology and modern design with innovative luxury, making luxury accessible for everyone. Our vision is to create homes that not only boast aesthetic excellence and innovative features but also enhance the living experience of our customers through sustainability and smart solutions.&rdquo;
                  </p>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="left" delay={0.3} className="flex">
              <div className="group flex flex-col md:flex-row gap-6 lg:gap-8 items-center md:items-start bg-white p-6 md:p-8 rounded-3xl border border-[#dfc28c]/30 hover:border-[#dfc28c] shadow-lg hover:shadow-xl transition-all duration-300 w-full">
                <div className="relative w-48 h-56 rounded-2xl overflow-hidden shrink-0 bg-[#0a192f] shadow-md border-2 border-[#dfc28c]/30">
                  <img
                    src="/assets/images/WhatsApp-Image-2025-10-01-at-1.01.10-PM.jpeg"
                    alt="Mr. Mou Shaojiu"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 filter contrast-[1.05]"
                  />
                </div>
                <div className="flex flex-col justify-center text-center md:text-left">
                  ...
                  <h3 className="font-heading text-xl md:text-2xl font-bold text-[#0a192f] mt-1">Mr. Mou Shaojiu</h3>
                  <span className="text-xs text-zinc-400 font-semibold mt-0.5">Director, Edifice Properties Limited</span>
                  <p className="text-zinc-500 text-xs md:text-sm leading-relaxed mt-4">
                    &ldquo;At Edifice Properties Limited, we believe that construction is not just about building structures, but about creating enduring value for our clients and communities. With a strong foundation in both construction management and contractor supervision, I personally ensure that every project is executed with precision, efficiency, and integrity.&rdquo;
                  </p>
                </div>
              </div>
            </ScrollReveal>
      ...
      <section className="py-24 bg-white border-b border-zinc-100">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <VideoModal
            ...
            thumbnail="/assets/images/horizon.png"
            title="Horizon Residency & Edifice Property Developments"
          />
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/5 border border-white/5 p-8 rounded-3xl flex flex-col justify-between min-h-[300px]">
              <p className="text-white/70 italic leading-relaxed text-sm">
                &ldquo;Buying my first apartment with Edifice Properties was the best decision I ever made. The team guided me through every step, from the site visit to paperwork, making the process smooth and stress-free. Today, I’m a proud home owner and couldn’t be happier with the quality and finishing of my home.&rdquo;
              </p>
              <div className="mt-8 border-t border-white/10 pt-4 flex flex-col">
                <span className="font-heading font-bold text-gold-500">Sarah K.</span>
                <span className="text-xs text-white/40">Kampala Resident</span>
              </div>
            </div>

            <div className="bg-white/5 border border-white/5 p-8 rounded-3xl flex flex-col justify-between min-h-[300px]">
              <p className="text-white/70 italic leading-relaxed text-sm">
                &ldquo;Our family needed more space, and Edifice Properties delivered beyond our expectations. The 3BHK apartment at Horizon Residency has everything we dreamed of – modern design, secure environment, and great amenities for our kids. It truly feels like home.&rdquo;
              </p>
              <div className="mt-8 border-t border-white/10 pt-4 flex flex-col">
                <span className="font-heading font-bold text-gold-500">Mr. Okello</span>
                <span className="text-xs text-white/40">Entebbe Resident</span>
              </div>
            </div>

            <div className="bg-white/5 border border-white/5 p-8 rounded-3xl flex flex-col justify-between min-h-[300px]">
              <p className="text-white/70 italic leading-relaxed text-sm">
                &ldquo;As an investor, I look for professionalism and reliability. Edifice Properties not only provided excellent property options but also gave me a strong return on my investment. Their projects are strategically located and built with great attention to detail.&rdquo;
              </p>
              <div className="mt-8 border-t border-white/10 pt-4 flex flex-col">
                <span className="font-heading font-bold text-gold-500">James M.</span>
                <span className="text-xs text-white/40">Real Estate Investor</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col text-sm">
                  ...
                  <div className="flex flex-wrap gap-x-4 gap-y-1 text-zinc-500 font-semibold mt-0.5">
                    <a href="tel:+256786000112" className="hover:text-gold-500 transition-colors">+256 786 000 112</a>
                    <a href="tel:+256763700206" className="hover:text-gold-500 transition-colors">+256 763 700 206</a>
                  </div>
                </div>
              </div>
