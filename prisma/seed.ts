...
async function main() {
  ...
  const propertyImages = [
    ...
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/E.png', category: 'interior', label: 'Executive Living Room', description: 'Bright and spacious living room layout featuring custom wall paneling, ceiling lighting details, and large view windows.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/F.png', category: 'interior', label: 'State-of-the-Art Kitchen', description: 'High-end fitted kitchen layout featuring premium cabinetry, integrated appliances, and clean countertops.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/FOYER-01.png', category: 'interior', label: 'Grand Entrance Foyer', description: 'Elegant entrance foyer and hallway paneling, welcoming residents with luxury detailing.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/G.png', category: 'interior', label: 'Master Bedroom Suite', description: 'Bespoke master suite bedroom design detailing plush headboard panels, gold accents, and broad windows.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/H.png', category: 'interior', label: 'Modern Dining Area', description: 'Sophisticated dining salon space seamlessly connected with the main lounge area.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/I.png', category: 'interior', label: 'Luxury Bathroom', description: 'Stylishly finished bathroom layout with premium fixtures, wall-mounted vanities, and contemporary tiling.' },
    // Also use B, C, D as floor plans as dynamic fallback
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/B.png', category: 'floorplan', label: '1BHK Dimensions & Sizing Sheets', description: 'Technical drawing demonstrating room boundaries, structural doors, and plumbing pipes layout.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/C.png', category: 'floorplan', label: '2BHK Dimensions & Sizing Sheets', description: 'Comprehensive 2-bedroom dimensions outlining balcony spaces and kitchen counter widths.' },
    { propertyId: 'signature-residency', url: '/assets/edifice/signature%20residency/D.png', category: 'floorplan', label: '3BHK Executive Penthouses Layout', description: 'Upper floor planning detailing maids rooms, separate laundry utilities, and penthouse layouts.' }
  ];
